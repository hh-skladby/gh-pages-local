...
```sh
 .jekyll-cache/
 .jekyll-metadata/
 .sass-cache/ # Sass CSS preprocessor - used in HTML themes
...
... [dependencies of GitHub Pages Ruby Gem](https://github.com/github/pages-gem/blob/master/lib/github-pages/dependencies.rb) hints to required plugins
